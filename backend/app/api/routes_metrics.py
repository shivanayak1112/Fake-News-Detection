...
async def get_model_metrics() -> dict:
    ...
    return {
        ...
        "precision": holdout.get("precision_fake", 0),
        "recall": holdout.get("recall_fake", 0),
        "f1_score": holdout.get("f1_fake", 0),
        "test_samples": int(weighted.get("support", 0)) if weighted.get("support") else 0,
    }
